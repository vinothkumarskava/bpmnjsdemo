...
module.exports = function(group, element, bpmnFactory, canvas, translate, options) {
  ...
  if (is(element, 'bpmn:Task') && bo.customElementName == SUITABILITY_PROCESS_PRICE) {
    var options = { id:"processPrice_operation" , label: translate('operation'), modelProperty: 'operation', label: translate('Operation'), inputArr: [{name: "Markup",value: "Markup"},{name: "Markdown",value: "Markdown"},{name: "RoundUp",value: "RoundUp"},{name: "RoundDown",value: "RoundDown"}] };
