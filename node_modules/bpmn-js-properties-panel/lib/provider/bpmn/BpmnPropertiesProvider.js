...
function createGeneralTabGroups(
  ...
  var options = {inputArr : [{name: "Markup",value: "Markup"},{name: "Markdown",value: "Markdown"},{name: "RoundUp",value: "RoundUp"},{name: "RoundDown",value: "RoundDown"}]};
  taskProps(detailsGroup, element, bpmnFactory, canvas, translate, options);
