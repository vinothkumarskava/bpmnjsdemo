...
function createGeneralTabGroups(
  ...
  var tempArr = [];
  forEach(elementConfigurations.input_fields, function(option) {
    tempArr.push({"name": option.name, "value": option.name});
  });
  elementConfigurations.condFPKey = tempArr;

  // Appending the hard coded values to the original config
  elementConfigurations.PPAdjustmentOperation = [{"name":"Markup","value":"Markup"},{"name":"Markdown","value":"Markdown"}];
  elementConfigurations.PPRoundoffOperation = [{"name":"RoundUp","value":"RoundUp"},{"name":"RoundDown","value":"RoundDown"}];
  ...
  elementConfigurations.condOperator = [{"name":"Equals","value":"Equals"},{"name":"Not Equals","value":"Not Equals"}];
